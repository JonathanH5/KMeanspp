...
public class KMeansppGeneric<T> implements Serializable {
     ...
     */
    public final class PointCentroidConverter implements MapFunction<T, Tuple2<Integer, T>> {
     ...
     */
    public final class PickOnePoint implements ReduceFunction<T> {
     ...
     */
    public final class PickWithDistance extends AbstractRichFunction implements GroupReduceFunction<Tuple2<T, Double>, Tuple2<Integer, T>> {
        ...
        @Override
        public void reduce(Iterable<Tuple2<T, Double>> distance, Collector<Tuple2<Integer, T>> out) throws Exception {

            Random r = new Random();
            double pos = r.nextDouble() * sum;

            Iterator<Tuple2<T, Double>> iterator = distance.iterator();
			while (iterator.hasNext()) {
                Tuple2<T, Double> d = iterator.next();
                pos -= d.f1;
                if (pos < 0) {
     ...
     */
    public final class AddNewCenter extends AbstractRichFunction implements GroupReduceFunction<Tuple2<Integer, T>, Tuple2<Integer, T>> {

		private static final long serialVersionUID = 2594819422245127304L;
        ...
        @Override
        public void reduce(Iterable<Tuple2<Integer, T>> values, Collector<Tuple2<Integer, T>> out) throws Exception {
            Iterator<Tuple2<Integer, T>> iterator = values.iterator();
			while (iterator.hasNext()) {
     ...
     */
    public final class SelectNearestCenter extends AbstractRichFunction implements MapFunction<T, Tuple2<Integer, T>> {
     ...
     */
    public final class SelectNearestDistance extends AbstractRichFunction implements MapFunction<T, Tuple2<T, Double>> {
     ...
     */
    public final class CountAppender implements MapFunction<Tuple2<Integer, T>, Tuple3<Integer, T, Long>> {
     ...
     */
    public final class CentroidAccumulator implements ReduceFunction<Tuple3<Integer, T, Long>> {
     ...
     */
    public final class CentroidAverager implements MapFunction<Tuple3<Integer, T, Long>, Tuple2<Integer, T>> {
